...
# def is_hour_param(param: str) -> bool:
#     """
#     Проверяет, является ли параметр запросом статистики по часам.
    
#     Args:
#         param: Параметр команды
    
#     Returns:
#         bool: True если параметр соответствует запросу статистики по часам
#     """
#     return param == "hour" or param == "hours"


# def is_weekday_param(param: str) -> bool:
#     """
#     Проверяет, является ли параметр запросом статистики по дням недели.
    
#     Args:
#         param: Параметр команды
    
#     Returns:
#         bool: True если параметр соответствует запросу статистики по дням недели
#     """
#     return param == "weekday" or param == "weekdays"


# async def handle_hours_stats(message: Message, tz: pytz.BaseTzInfo, now: datetime) -> None:
#     """
#     Обрабатывает запрос статистики по часам за все время.
...
# async def handle_weekdays_stats(message: Message, tz: pytz.BaseTzInfo, now: datetime) -> None:
#     """
#     Обрабатывает запрос статистики по дням недели за все время.
...
# async def handle_year_stats(message: Message, tz: pytz.BaseTzInfo, now: datetime) -> None:
#     """
#     Обрабатывает запрос статистики за текущий год.
...
# async def handle_all_stats(message: Message) -> None:
#     """
#     Обрабатывает запрос статистики за все время.
...
# async def handle_month_stats(message: Message, param: str, tz: pytz.BaseTzInfo, now: datetime) -> None:
#     """
#     Обрабатывает запрос статистики за конкретный месяц.
    
#     Args:
#         message: Объект сообщения
#         param: Параметр команды (номер месяца)
#         tz: Часовой пояс
#         now: Текущее время
#     """
...
#     except ValueError:
#         await send_invalid_param_message(message)


# async def send_invalid_param_message(message: Message) -> None:
#     """
#     Отправляет сообщение об ошибке неверного параметра команды /stats.
...
#         if is_hour_param(param):
#             await handle_hours_stats(message, tz, now)
#         elif is_weekday_param(param):
#             await handle_weekdays_stats(message, tz, now)
#         elif param == "year":
#             await handle_year_stats(message, tz, now)
#         elif param == "all":
#             await handle_all_stats(message)
#         else:
#             await handle_month_stats(message, param, tz, now)
