...
#### `/stats` - Статистика
Расширенная статистика пересылок с графиками активности.

**Базовый вариант (без параметров):**
```
/stats
```
→ Показывает статистику за текущий месяц: количество пересылок за сегодня, оставшийся лимит, топ-3 пользователей

**Статистика за конкретный месяц:**
```
/stats 1   # Январь текущего года
/stats 12  # Декабрь
```
→ Статистика за указанный месяц с графиком активности по дням месяца
→ Доступны только последние 12 месяцев

**Статистика за год:**
```
/stats year
```
→ Статистика за текущий год с графиком активности по месяцам

**Статистика за все время:**
```
/stats all
```
→ Общая статистика за все время работы бота

**График активности по часам:**
```
/stats hour
```
→ Столбчатый график активности по часам дня за все время работы бота

**График активности по дням недели:**
```
/stats weekday
```
→ Столбчатый график активности по дням недели за все время работы бота
...
- **База данных:** SQLite
- **Визуализация:** matplotlib для графиков статистики
...
#### 🛠️ **src/utils/**
Вспомогательные функции для форматирования сообщений, получения информации о пользователях и генерации графиков:
- `helpers.py` - форматирование сообщений, работа с цитатами
- `charts.py` - генерация столбчатых графиков через matplotlib (активность по часам, дням недели, дням месяца, месяцам года)
